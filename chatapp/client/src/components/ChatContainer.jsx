...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-y-auto scrollbar-hide relative backdrop-blur-lg '>
      ...
      {/**-- header--**/}
         ...
         {/*chat area*/}
         <div className="overflow-y-auto scrollbar-thin scrollbar-thumb-transparent scrollbar-track-transparent h-[calc(100%-120px)] flex flex-col relative p-3 pb-6 ">
         ...
         {/*----bottom area----*/}
         <div className='absolute bottom-0 left-0 right-0 flex items-center gap-3 p-3 flex-1 '>
